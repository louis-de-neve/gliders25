from setup import import_split_and_make_transects, Profile, Transect, two_dimensional_binning
...
transects, all_valid_profiles = import_split_and_make_transects(use_downcasts=False,
                                                                use_cache=True,)
