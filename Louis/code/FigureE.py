...
ax: Axes = fig.add_axes([0.08, 0.1, 0.19, 0.8])
ax2: Axes = fig.add_axes([0.29, 0.1, 0.19, 0.8], sharey=ax)
ax3: Axes = fig.add_axes([0.50, 0.1, 0.19, 0.8], sharey=ax)
...
pcm = new_binned_plot(profiles, ax, "bbp", cmap=my_cmap, norm=my_norm)
pcm = new_binned_plot(profiles, ax2, "bbp_minimum_despiked", cmap=my_cmap, norm=my_norm)
pcm = new_binned_plot(profiles, ax3, "bbp_debubbled_despiked", cmap=my_cmap, norm=my_norm)
pcm = new_binned_plot(profiles, ax4, "bbp_debubbled_spikes_denoised", cmap=my_cmap, norm=my_norm)
